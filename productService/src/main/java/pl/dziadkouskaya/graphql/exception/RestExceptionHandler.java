...
public class RestExceptionHandler {
    ...
    public ResponseEntity<RestErrorResponse> handleAccessDeniedException(HttpRequestMethodNotSupportedException ex, WebRequest request) {
        return handleInternal(ex, HttpStatus.NOT_FOUND, RESOURCE_NOT_FOUND);
    }
    ...
    private ResponseEntity<RestErrorResponse> handleInternal(Exception ex, HttpStatus status, List<String> errors) {
